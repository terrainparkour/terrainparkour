...
local function makeBadgeRowFrame(
	...
	local badgeNameLabel =
		guiUtil.getTl("01badgename", UDim2.new(sectionWidthsScale.badge, 0, 1, 0), 2, fr, colors.defaultGrey, 1)

	badgeNameLabel.Text = badge.name
	toolTip.setupToolTip(localPlayer, badgeNameLabel, badge.hint, toolTip.enum.toolTipSize.NormalText)
