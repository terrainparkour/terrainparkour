...
function CreateMeCommandChannelEchoMessageLabel(messageData)
	...
	local useFont = extraData.Font or Enum.Font.Gotham
	...
	local function UpdateTextFunction(newMessageObject)
		BaseMessage.Text = string.rep(" ", numNeededSpaces2)
			.. newMessageObject.FromSpeaker
			.. " "
			.. string.sub(newMessageObject.Message, 5)
	end
